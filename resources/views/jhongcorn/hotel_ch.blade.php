...
<div class="card  text-center">
    ...
    <div class=" up-img card-img-overlay">
        ...
        <img class="avatar rounded-circle gradient-card-header purple-gradient img-thumbnail"  src="<?php echo $row['Picture1']!=""?$row['Picture1']:'/resources/views/jhongcorn/img/bg.png';?>" onerror="this.src='/resources/views/jhongcorn/img/bg.png'">
    </div>
